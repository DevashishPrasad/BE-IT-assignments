	...
	<div class="main_content" style="background-color:#fff;">
		...
		<div class="formstyles" style="background-color: #101011;color: #0d0623;">
				<div class="col-md-12">
					...
					<div class="col-md-4" style="float:left;padding:20px 13.9%;border: 1px solid lightgrey;margin-left:50%px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
						<a style="font-size:15px;" href="patient_login.php">Patient login</a>
						<a style="font-size:15px;" href="doctorlogin.php">Doctor login</a>
					</div>
					<div class="col-md-4"></div>
