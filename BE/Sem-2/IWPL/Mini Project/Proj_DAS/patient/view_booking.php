...
<li ><a href='dashboard.php'>Home</a></li>
   ...
   <li class='active'><a href='view_booking.php'>View Appointments</a></li>
        ...
        <div class="panel panel-primary filterable">
			...
			<!-- <div class="all_user" style="margin-top:0px; margin-left: 40px;"> -->
				<?php 
					...
					$sql = "SELECT doctor.`name` ,doctor.`service` ,doctor.`address` ,doctor.`qualify` ,doctor.`expertise` ,doctor.`fee` ,doctor.`email` ,doctor.`contact` , booking.`day` , booking.`date`,booking.`time`,booking.`booking_id` 
					FROM doctor ,booking
					WHERE booking.`dr_id` = doctor.`userid` and booking.`ic_patient`= '".$_SESSION['icPatient']."'  ";
					// echo $sql;
					...
					// $sql2 = " SELECT * FROM doctor WHERE  userid= '".$dr_id."'  ";
					// $res_2 =mysqli_query($con,$sql2);
					// $row2=mysqli_fetch_array($res_2);
					// $count2 = mysqli_num_rows($result);


					if($count>=1){?><table style="width:100%" class="table table-bordered table-striped">
						<thead>
							<tr class="filters">
							<th><input style="text-align:center;" type="text" class="form-control" placeholder="Booking ID" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Doctor Name" disabled></th>
                        ...
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Fee" disabled></th>
					...
					<tbody>
						...
						while($row=mysqli_fetch_array($result)){
							...
							$time=$hr.":".sprintf('%02d',$min);
								...
								echo "<td>".$row['day']."</td>";
								echo "<td>".$time."</td>";
								echo "<td class='text-center'><a href='#' id='".$row['booking_id']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
									</td>";
								echo "</tr>";
						}
						echo "</table>";
