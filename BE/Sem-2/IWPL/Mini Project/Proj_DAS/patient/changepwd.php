...
<li ><a href='dashboard.php'>Home</a></li>
   ...
   <li><a href='logout.php'>Logout</a></li>
	...
	<div class="dashboard" style="background-color:#fff;">
		...
		<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:595px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
			...
			<?php 
					...
					include_once '../assets/conn/dbconnect.php';
							...
							$sql= "SELECT * FROM user WHERE icPatient= '" . $_SESSION["icPatient"]."' AND password= '" . $_POST["password"]."'";
							...
							if($row>0){
								...
								$sql1="UPDATE user SET password='" . $_POST["newpassword"]  ."' WHERE icPatient='" .$_SESSION["icPatient"] ."'";
