...
<html>
	...
	<div class="login" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Patient Login</h3>
			<div class="formstyle" style="margin-left:29%;padding:20px;border: 1px solid lightgrey;margin-right:415px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center form-group" style="text-align:center;">
					<label>
						 <input style="width:250px;height:30px;text-align:center;" type="text" name="ic"  placeholder="User ID" required>
					</label><br><br>
					<label>
						 <input style="width:250px;height:30px;text-align:center;" name="password" type="password"  placeholder="password" required>
					</label><br><br>
					<button name="submit" type="submit" style="float:right;margin-right:40%;margin-top:20px;width: 85px;border-radius: 3px;">Login</button> 
					<br><br>
          ...
          include_once 'assets/conn/dbconnect.php';
							...
							$sql= "SELECT * FROM user WHERE icPatient= '" . $_POST["ic"]."' AND password= '" . $_POST["password"]."'";

							$result = $con->query($sql);

									if ($result->num_rows > 0) {
											$_SESSION["icPatient"]= $_POST["ic"];
