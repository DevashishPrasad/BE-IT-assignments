...
<div class="dashboard" style="background-color:#fff;">
    ...
    <h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">All registered Doctors List</h3>
    
</div>
    <div style="float:right;margin-right:10px;">
    <form action="add_doctor.php" method="post" >
    <button type='submit' name='submit' style='color:#000;padding:8px;'>ADD DOCTOR</button>
  </form>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <?php 
					...
					<thead>
                	    <tr class="filters">
						<th><input style="text-align:center;" type="text" class="form-control" placeholder=" Doctor ID" disabled></th>
                        ...
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Qualification" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Service Area" disabled></th>
                ...
                echo "<form method='POST'>";
                            echo "<td class='text-center'><a href='#' id='".$row['userid']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                    </td>";
