...
<ul>
   ...
   <li class='active'><a href='view_feedback.php'>Feedback</a></li>
...
<div class="dashboard" style="background-color:#fff;">
    <h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">Customer Feedback </h3>
...
<div class="container-fluid">
    ...
    <?php 
              ...
              <table style="width:100%" class="table table-bordered table-striped">
                <thead>
                    <tr class="filters">
                    <th><input style="text-align:center;" type="text" class="form-control" placeholder="Feedback ID" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Email" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Feedback" disabled></th>
