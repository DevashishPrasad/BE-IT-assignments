...
<ul>
   ...
   <li class='active'><a href='view_contact.php'>Contact Us</a></li>
   <li><a href='logoutadmin.php'>Logout</a></li>

</ul>
</div><!-- this is for donor registraton -->
<div class="dashboard" style="background-color:#fff;">
    <h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">Customer Queries </h3>
...
<div class="container-fluid">
    ...
    <?php 
              ...
              <table style="width:100%" class="table table-bordered table-striped">
                <thead>
                    <tr class="filters">
                    <th><input style="text-align:center;" type="text" class="form-control" placeholder="Customer ID" disabled></th>
                    <th><input style="text-align:center;" type="text" class="form-control" placeholder="Name" disabled></th>
                    <th><input style="text-align:center;" type="text" class="form-control" placeholder="Phone No." disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Email" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Subject" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Message" disabled></th>
                ...
                <tbody>
                    ...
                    while($row=mysqli_fetch_array($result)){
                            ...
                            echo "<td>".$row['msg']."</td>";
                            echo "<td class='text-center'><a href='#' id='".$row['contact_id']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
