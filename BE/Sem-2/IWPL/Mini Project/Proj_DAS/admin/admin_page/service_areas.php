...
<li ><a href='adminpanel.php'>Home</a></li>
   ...
   <li class='active'><a href='service_areas.php'>Service Areas</a></li>
...
<div class="dashboard" style="background-color:#fff;">
    <h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">All Service Areas</h3>
    
    
</div><br>
<form method="post" action="addservice.php">
<table style="width:40%;padding:5px;" >
                <thead>
                    <tr>
                    <th style="float:right;color:black;margin-right:39px;"><input style="text-align:center;" style="text-align:center;" type="text" placeholder="Area" name="area" ></th>
                    <th style="float:right;color:black;margin-right:30px;"><input style="text-align:center;" style="text-align:center;" type="number"  placeholder="Pincode" name="pin" ></th>
                        <th ><button type='submit' name='submit' style='float:right;color:#000;padding-right:20px;padding-left:20px;margin-right:10px;'>ADD Area</button></th>
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            ...
            <?php 
                ...
                <thead>
                    <tr class="filters">
                    <th><input style="text-align:center;" style="text-align:center;" type="text" class="form-control" placeholder="Area" disabled></th>
                        <th><input style="text-align:center;" type="text" class="form-control" placeholder="Pin Code" disabled></th>
                ...
                <tbody>           
                    ...
                    while($row=mysqli_fetch_array($result)){
                            ...
                            echo "<td class='text-center'><a href='#' id='".$row['pin']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                    </td>";
