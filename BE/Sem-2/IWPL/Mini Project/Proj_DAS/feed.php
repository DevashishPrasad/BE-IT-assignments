...
<body>
  <div class="wrapper">
    <form method="post" action="view_feed.php"  class="form">
      <div class="pageTitle title">Feedback </div>
      <div class="secondaryTitle title">Please fill this form to sign up.</div>
      <input name="name" type="text" class="name formEntry" placeholder="Name" required/>
      <input name="email" type="email" class="email formEntry" placeholder="Email" required/>
      <textarea name="msg" class="message formEntry" placeholder="Message" required></textarea>
